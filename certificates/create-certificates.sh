...
./create-certificate.py "$list" "$date" "10 Node BW Score" io500-10-node.csv 10node-bw "io500__bw"
./create-certificate.py "$list" "$date" "10 Node MD Score" io500-10-node.csv 10node-md "io500__md"
